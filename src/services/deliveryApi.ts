...
class DeliveryService {
  ...
  private getMockActiveDelivery(): DeliveryOrder {
    return {
      ...
      trafficAlerts: [],
      emergencyContacts: [
        { name: 'Customer Support', number: '+91 1800-123-4567', type: 'support', priority: 1 },
        { name: 'Emergency Services', number: '112', type: 'emergency', priority: 1 },
        { name: 'Warehouse Manager', number: '+91 120-4567890', type: 'warehouse', priority: 2 },
        { name: 'Customer', number: '+91 9123456789', type: 'customer', priority: 3 }
      ]
    };
  }
